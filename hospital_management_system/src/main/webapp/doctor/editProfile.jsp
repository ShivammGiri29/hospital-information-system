		...
		<div class="row">
			<div class="col-md-4 ">
				<div class="card paint-card">
					...
					<div class="card-body">
						<form action="../doctChangedPassword" method="post">
							<div class="mb-3">
							...
							<button class="btn custom-btn col-md-12">Change
								Password</button>
						</form>
				...
				<div class="card paint-card">
					...
					<div class="card-body">
						<form action="../doctorUpdateProfile" method="post">
							...
							<button type="submit" class="btn custom-btn col-md-12 ">Update</button>
						</form>
